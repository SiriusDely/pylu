...
ap.add_argument("-e", "--east", type=str, required=True, help="path to the input EAST text detector")
ap.add_argument("-v", "--video", type=str, help="path to optional input video")
...
# if we are using webcam, release the pointer
if not args.get("video", False):
    vs.stop()
